...
const getAccountModel = (data) => {
  return new Promise((resolve, reject) => {
    const queryString =
      "SELECT u.id, u.status, u.email, u.username, u.phone, u.avatar, b.balance_nominal as balances, u.pin FROM users u LEFT JOIN balances b ON u.id = b.user_id WHERE u.id = ?";
